    ...
    <section className="max-w-[1440px] mx-auto px-4 py-16">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <motion.button
                      ...
                      className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm
                        ...
                        hover:bg-[#B88E2F] hover:border-transparent transition-colors"
                    >
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="px-8 py-3 bg-[#B88E2F] text-white rounded-full
            hover:bg-[#A07B2A] transition-colors inline-flex items-center gap-2"
        >
          View All Categories
