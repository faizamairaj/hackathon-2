    ...
    <section className="max-w-[1440px] mx-auto px-4 py-16 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Real experiences from our valued customers who have transformed their spaces
          with our furniture.
        </p>
      </motion.div>
      ...
      <div className="relative h-[500px]">
                        ...
                        <div>
                          ...
                          <div className="flex gap-1 mt-2">
                            {[...Array(testimonials[currentIndex].rating)].map((_, i) => (
                              <Star key={i} className="w-5 h-5 fill-[#B88E2F] text-[#B88E2F]" />
                            ))}
                          </div>
                        </div>
                      </div>
        ...
        <button
          className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full 
            ...
            hover:text-[#B88E2F] transition-colors z-10"
          onClick={() => paginate(-1)}
        >
